...
export class ServicioUltimosmodelosService {

  private ultimosmodelos:ultimosmodelos[]=[
    {
      ...
      genero:'hombres',
      nombre_producto:'ADIDAS GRAND COURT BEYOND',
      precio:'$1,299'
    },
    {
    ...
    },
    {
      ...
      genero:'hombres',
      nombre_producto:'TERREX AX4 PRIMEGREEN 5',
      precio:'$1,630'
    },
    {
  ...
  gethombres()
{return this.ultimosmodelos};

constructor() {
  console.log("servicio de hombre para usar..");
 }
}
export interface ultimosmodelos{
img:string;
genero:string;
